...
GTEST_TEST(KernelTest, CudaMatmul) {
  ...
  for (int i = 0; i < num_equations; i++) {
    ...
    Eigen::MatrixXd C_1(128, 128);
    Eigen::MatrixXd C_2(128, 128);
    Eigen::MatrixXd Res_add_1(128, 128);
    Eigen::MatrixXd Res_add_2(128, 128);
    Eigen::MatrixXd Res_sub_1(128, 128);
    Eigen::MatrixXd Res_sub_2(128, 128);
  ...
  matrixMultiply_32thd(v_A, v_B, v_C_1, num_equations);
  ...
  matrixLinOp_32thd(v_A, v_B, v_Res_add_1, LinOpType::ADD, num_equations);
  ...
  matrixLinOp_32thd(v_A, v_B, v_Res_sub_1, LinOpType::SUB, num_equations);
